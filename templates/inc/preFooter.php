<div id="preFooter">
	<ul class="partnerList fltlft" >
		<li><img src="<?php echo base_path(). path_to_theme(); ?>/images/partnerLink01.jpg" alt="Sponsor logo"/></li>
		<li><img src="<?php echo base_path(). path_to_theme(); ?>/images/partnerLink02.jpg" alt="Sponsor logo"/></li>
		<li><img src="<?php echo base_path(). path_to_theme(); ?>/images/partnerLink03.jpg" alt="Sponsor logo"/></li>
		<li><img src="<?php echo base_path(). path_to_theme(); ?>/images/partnerLink04.jpg" alt="Sponsor logo"/></li>
		<li><img src="<?php echo base_path(). path_to_theme(); ?>/images/partnerLink05.jpg" alt="Sponsor logo"/></li>
		<li><img src="<?php echo base_path(). path_to_theme(); ?>/images/partnerLink06.jpg" alt="Sponsor logo"/></li>
	</ul>
	<p class="clear">&nbsp;</p>
